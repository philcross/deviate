...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadCollection: function loadCollection() {
      ...
      window.axios.get('/activity-collections/' + this.id).then(function (response) {
        ...
        _this.form = new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_2__["default"]({
          ...
          activities_start_at: _this.collection.dates.activities.start,
          activities_end_at: _this.collection.dates.activities.end,
    ...
    updateCollection: function updateCollection() {
      ...
      this.form.put('/activity-collections/' + this.id).then(function (response) {
    ...
    [
      ...
      _c(
        ...
        [
          _c(
            "brand-portlet",
            { attrs: { title: "Edit Activity Collection" } },
            [
              _c("collection-form", {
                attrs: {
                  form: _vm.form,
