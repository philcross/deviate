...
/* harmony import */ var _components_portlets_standard_BrandPortlet__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @components/portlets/standard/BrandPortlet */ "./resources/frontend/components/portlets/standard/BrandPortlet.vue");
...
/* harmony import */ var _components_buttons_basic_DangerButton__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @components/buttons/basic/DangerButton */ "./resources/frontend/components/buttons/basic/DangerButton.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'avatar',
  components: {
    DangerButton: _components_buttons_basic_DangerButton__WEBPACK_IMPORTED_MODULE_9__["default"],
    ...
    BrandPortlet: _components_portlets_standard_BrandPortlet__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  props: {
    id: {
      required: true
  ...
  data: function data() {
    return {
      user: null,
      avatarForm: new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_0__["default"]({
        avatar: null
      }),
      deleteAvatarForm: new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_0__["default"]({})
    };
  },
  methods: {
    ...
    updateAvatar: function updateAvatar() {
      ...
      _modules_errors_ErrorBus__WEBPACK_IMPORTED_MODULE_1__["default"].clear();
      this.avatarForm.upload('/users/' + this.user.id + '/avatar').then(function () {
        new _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_2__["default"]().success('Details Update', "This users core details have been successfully updated.");

        _this2.$emit('user-updated');
      }).catch(function (error) {
        _modules_errors_ErrorBus__WEBPACK_IMPORTED_MODULE_1__["default"].record(error);
      }).then(function () {
    ...
    deleteAvatar: function deleteAvatar() {
      ...
      _modules_errors_ErrorBus__WEBPACK_IMPORTED_MODULE_1__["default"].clear();
      this.deleteAvatarForm.delete('/users/' + this.user.id + '/avatar').then(function (response) {
        new _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_2__["default"]().success('Avatar Deleted', 'This users avatar has been successfully deleted.');
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  attrs: {
                                    actioning: _vm.avatarForm.isSubmitting
                                  },
