...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      collection: null,
      activity: null,
      editDetailsForm: new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_2__["default"]({
        name: '',
        description: '',
        places: '',
        price: '',
  ...
  methods: {
    ...
    loadActivity: function loadActivity() {
      ...
      window.axios.get('/activity-collections/' + this.collectionId + '/activities/' + this.activityId).then(function (response) {
        ...
        _this2.editDetailsForm = new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_2__["default"]({
          name: _this2.activity.name,
          description: _this2.activity.description,
          places: _this2.activity.places,
          price: _this2.activity.price.raw / 100,
          starts_at: _this2.activity.dates.starts_at,
          ends_at: _this2.activity.dates.ends_at
        });
      }).catch(function (error) {
        return console.log(error);
      });
    ...
    updateActivity: function updateActivity() {
      this.editDetailsForm.put('/activity-collections/' + this.collectionId + '/activities/' + this.activityId).then(function () {
        return new _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_0__["default"]().success('This activity has been updated.');
      }).catch(function (error) {
        return console.log(error);
      });
    },
