...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("plan-item", {
        attrs: { plan: _vm.plans.monthly, selected: _vm.plan === "monthly" },
        on: {
          "select-plan": function($event) {
            _vm.selectPlan("monthly")
          }
        }
      }),
      _vm._v(" "),
      _c("plan-item", {
        attrs: { plan: _vm.plans.annual, selected: _vm.plan === "annual" },
        on: {
          "select-plan": function($event) {
            _vm.selectPlan("annual")
          }
        }
      }),
      _vm._v(" "),
      _c("plan-item", {
        attrs: { plan: _vm.plans.network, selected: _vm.plan === "network" },
        on: {
          "select-plan": function($event) {
            _vm.selectPlan("network")
          }
        }
      })
    ],
