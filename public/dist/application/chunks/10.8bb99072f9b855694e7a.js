  ...
  methods: {
    createUser: function createUser() {
      ...
      this.form.post('/users').then(function (response) {
        ...
        _this.$router.push('/users/' + response.data.data.id);
      });
    }
  }
});
      ...
      [
        _c(
          ...
          [
            _c(
              "core-details-form",
              { attrs: { form: _vm.form }, on: { submit: _vm.createUser } },
              [
                _c("personal-details-form", { attrs: { form: _vm.form } }),
                _vm._v(" "),
                _c("password-form", { attrs: { form: _vm.form } })
              ],
              1
            )
          ],
