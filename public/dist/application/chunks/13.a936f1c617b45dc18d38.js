...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_PlanItem__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/PlanItem */ "./resources/frontend/applications/organisations/components/PlanItem.vue");
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@applications/organisations/data/annual_network'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'edit-plan',
  components: {
    PlanItem: _components_PlanItem__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {
      plans: {
        monthly: _applications_organisations_data_monthly_plan__WEBPACK_IMPORTED_MODULE_1__["default"],
        annual: _applications_organisations_data_annual_plan__WEBPACK_IMPORTED_MODULE_2__["default"],
        network: !(function webpackMissingModule() { var e = new Error("Cannot find module '@applications/organisations/data/annual_network'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
      }
    };
  },
  methods: {},
                  ...
                  _c("div", { staticClass: "m-list-search__results" }, [
                    _c("div", { staticClass: "m-list-search__result-item" }, [
                      ...
                      _c(
                        "div",
                        {
                          staticClass: "m-list--search__result-item-description"
                        },
                        [
                          _vm._v(
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "row" },
    [
      _c("plan-item", { attrs: { plan: _vm.monthly } }),
      _vm._v(" "),
      _c("plan-item", { attrs: { plan: _vm.annual } }),
      _vm._v(" "),
      _c("plan-item", { attrs: { plan: _vm.network } })
    ],
    1
  )
}
