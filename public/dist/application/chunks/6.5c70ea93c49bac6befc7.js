...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      user: null,
      updateForm: new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_5__["default"]({
        isLoaded: false,
        forename: '',
        surname: '',
        email: '',
  ...
  computed: {
    title: function title() {
      return this.user ? 'User Profile' : 'User Profile: ' + this.user.name.forename + ' ' + this.user.name.surname;
    }
  },
  methods: {
    loadUser: function loadUser() {
      ...
      window.axios.get('/users/' + this.id).then(function (response) {
        ...
        _this.updateForm = new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_5__["default"]({
          isLoaded: true,
    ...
    updateUser: function updateUser() {
      this.updateForm.put('/users/' + this.id).then(function () {
        return new _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_6__["default"]().success('Core details have been successfully updated.');
      }).catch(function (error) {
