...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    bookingOpensAt: moment__WEBPACK_IMPORTED_MODULE_0___default()(undefined.collection.dates.booking.opens).format('dddd, MMMM Do'),
    bookingClosesAt: moment__WEBPACK_IMPORTED_MODULE_0___default()(undefined.collection.dates.booking.closes).format('dddd, MMMM Do'),
    paymentOpensAt: moment__WEBPACK_IMPORTED_MODULE_0___default()(undefined.collection.dates.payment.opens).format('dddd, MMMM Do'),
    paymentClosesAt: moment__WEBPACK_IMPORTED_MODULE_0___default()(undefined.collection.dates.payment.closes).format('dddd, MMMM Do'),
    activitiesStartAt: moment__WEBPACK_IMPORTED_MODULE_0___default()(undefined.collection.dates.activites.start).format('dddd, MMMM Do'),
    activitiesEndAt: moment__WEBPACK_IMPORTED_MODULE_0___default()(undefined.collection.dates.activities.end).format('dddd, MMMM Do')
  }
});
...
var render = function() {
  ...
  return _c("tr", [
    ...
    _vm._v(" "),
    _c("td", [_vm._v("Monday 2nd February")]),
    _vm._v(" "),
    _c("td", [_vm._v("Monday 2nd February")]),
    _vm._v(" "),
    _c("td", [_vm._v("£40.00")]),
                ...
                ? _c(
                    "context-menu-item",
                    {
                      attrs: {
                        ...
                        url:
                          "/activity-collections/" + _vm.collection.id + "/edit"
                      }
                    },
