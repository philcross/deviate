...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    bookingOpensAt: function bookingOpensAt() {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(_this.collection.dates.booking.opens).format('dddd, MMMM Do');
    },
    bookingClosesAt: function bookingClosesAt() {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(_this.collection.dates.booking.closes).format('dddd, MMMM Do');
    },
    paymentOpensAt: function paymentOpensAt() {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(_this.collection.dates.payment.opens).format('dddd, MMMM Do');
    },
    paymentClosesAt: function paymentClosesAt() {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(_this.collection.dates.payment.closes).format('dddd, MMMM Do');
    },
    activitiesStartAt: function activitiesStartAt() {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(_this.collection.dates.activites.start).format('dddd, MMMM Do');
    },
    activitiesEndAt: function activitiesEndAt() {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(_this.collection.dates.activities.end).format('dddd, MMMM Do');
    }
  }
});
