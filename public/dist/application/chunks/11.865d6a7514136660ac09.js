  ...
  methods: {
    ...
    pay: function pay() {
      ...
      Object(vue_stripe_elements_plus__WEBPACK_IMPORTED_MODULE_0__["createToken"])().then(function (data) {
        _this2.form.token = data.token.id;

        _this2.form.post('/organisation/billing/cards').then(function (response) {
          _this2.cards.push(response.data.data);

          _this2.$refs.stripe_card.clear();
