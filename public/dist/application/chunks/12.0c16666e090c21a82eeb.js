...
/* harmony import */ var _components_buttons_submit_BrandButton__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @components/buttons/submit/BrandButton */ "./resources/frontend/components/buttons/submit/BrandButton.vue");
...
/* harmony import */ var _components_buttons_submit_DangerButton__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @components/buttons/submit/DangerButton */ "./resources/frontend/components/buttons/submit/DangerButton.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    BrandButton: _components_buttons_submit_BrandButton__WEBPACK_IMPORTED_MODULE_5__["default"],
    FormColumn: _components_forms_layouts_FormColumn__WEBPACK_IMPORTED_MODULE_4__["default"],
    DangerButton: _components_buttons_submit_DangerButton__WEBPACK_IMPORTED_MODULE_8__["default"],
  ...
  data: function data() {
    return {
      user: null,
      deactivateForm: new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_0__["default"](),
      deleteForm: new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_0__["default"](),
      restoreForm: new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_0__["default"]()
    };
  },
  methods: {
    ...
    deactivateUser: function deactivateUser() {
      this.deactivateForm.delete('/users/' + this.user.id).then(function () {
        return new _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_2__["default"]().success('User Deactivated', 'This users avatar has been successfully deactivated.');
      }).catch(function (error) {
        return _modules_errors_ErrorBus__WEBPACK_IMPORTED_MODULE_1__["default"].record(error);
      });
    },
    deleteUser: function deleteUser() {
      this.deleteForm.delete('/users/' + this.user.id).then(function () {
        new _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_2__["default"]().success('User Deactivated', 'This users avatar has been successfully deleted.');
    ...
    restoreUser: function restoreUser() {
      this.restoreForm.delete('/users/' + this.user.id + '/restore').then(function () {
        return new _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_2__["default"]().success('User Restored', 'This users avatar has been successfully restored.');
      }).catch(function (error) {
        return _modules_errors_ErrorBus__WEBPACK_IMPORTED_MODULE_1__["default"].record(error);
      });
    }
  ...
  return _c(
    ...
    [
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "danger-button",
                        {
                          attrs: { actioning: _vm.deactivateForm.isSubmitting },
      ...
      _vm.user.status === "deactivated"
        ? _c(
            "brand-portlet",
            { attrs: { title: "Restore User", icon: "flaticon-delete-1" } },
            [
              _c(
                "horizontal-form",
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "brand-button",
                        {
                          attrs: { actioning: _vm.restoreForm.isSubmitting },
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "danger-button",
                        {
                          attrs: { actioning: _vm.deleteForm.isSubmitting },
