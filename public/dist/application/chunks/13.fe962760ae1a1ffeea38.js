...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "m-widget27__btn" }, [
      _c(
        "button",
        {
          staticClass:
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "row" },
    [
      _c("plan-item", { attrs: { plan: _vm.plans.monthly } }),
      _vm._v(" "),
      _c("plan-item", { attrs: { plan: _vm.plans.annual } }),
      _vm._v(" "),
      _c("plan-item", { attrs: { plan: _vm.plans.network } })
    ],
    1
  )
}
