              ...
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "m-portlet__nav-link m-dropdown__toggle dropdown-toggle btn btn--sm m-btn--pill btn-secondary m-btn m-btn--label-brand",
                      attrs: { href: "#" }
                    },
                    [
                      _vm._v(
            ...
            _c("div", { staticClass: "m-widget4__item" }, [
              _c(
                ...
                [
                  _c("img", {
                    attrs: {
                      src: "/assets/app/media/img/files/javascript.svg",
                      alt: ""
                    }
                  })
                ]
            ...
            _c("div", { staticClass: "m-widget4__item" }, [
              _c(
                ...
                [
                  _c("img", {
                    attrs: {
                      src: "/assets/app/media/img/files/zip.svg",
                      alt: ""
                    }
                  })
                ]
