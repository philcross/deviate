        ...
        _c("div", { staticClass: "col-md-4" }, [
          _c(
            ...
            [
              _c(
                "div",
                { staticClass: "m-portlet__head m-portlet__head--fit" },
                [
                  _c("div", { staticClass: "m-portlet__head-caption" }, [
                    _c("div", { staticClass: "m-portlet__head-action" }, [
                      _c(
                        "button",
                        {
                          staticClass: "btn btn-sm m-btn--pill  btn-brand",
                          attrs: { type: "button" }
                        },
                        [_vm._v("Blog")]
                      )
                ...
                _c("div", { staticClass: "m-widget19" }, [
                  _c(
                    ...
                    [
                      _c("img", {
                        attrs: {
                          src: "/assets/app/media/img//blog/blog1.jpg",
                          alt: ""
                        }
                      }),
                      _vm._v(" "),
                  ...
                  _c("div", { staticClass: "m-widget19__content" }, [
                    _c("div", { staticClass: "m-widget19__header" }, [
                      _c("div", { staticClass: "m-widget19__user-img" }, [
                        _c("img", {
                          staticClass: "m-widget19__img",
                          attrs: {
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "m-widget19__info" }, [
                        _c("span", { staticClass: "m-widget19__username" }, [
                          _vm._v(
                            "\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tAnna Krox\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t"
                          )
                        ]),
                        ...
                        _c("br"),
                        _vm._v(" "),
                        _c("span", { staticClass: "m-widget19__time" }, [
                          _vm._v(
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "m-widget19__stats" }, [
                        _c(
                          "span",
                          { staticClass: "m-widget19__number m--font-brand" },
                          [
                            _vm._v(
                              "\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t18\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t"
                            )
                        ...
                        _vm._v(" "),
                        _c("span", { staticClass: "m-widget19__comment" }, [
                          _vm._v(
                            "\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tComments\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t"
                          )
                        ])
