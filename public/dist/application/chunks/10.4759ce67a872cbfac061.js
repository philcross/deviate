...
/* harmony import */ var _components_lists_basic_ActionableItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @components/lists/basic/ActionableItem */ "./resources/frontend/components/lists/basic/ActionableItem.vue");
/* harmony import */ var _components_forms_elements_ToggleSwitch__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @components/forms/elements/ToggleSwitch */ "./resources/frontend/components/forms/elements/ToggleSwitch.vue");
...
/* harmony import */ var _components_layout_header_FeatureHeader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @components/layout/header/FeatureHeader */ "./resources/frontend/components/layout/header/FeatureHeader.vue");
/* harmony import */ var _components_layout_header_ContextMenu__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @components/layout/header/ContextMenu */ "./resources/frontend/components/layout/header/ContextMenu.vue");
/* harmony import */ var _components_layout_header_ContextMenuItem__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @components/layout/header/ContextMenuItem */ "./resources/frontend/components/layout/header/ContextMenuItem.vue");
/* harmony import */ var _modules_errors_ErrorBus__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @modules/errors/ErrorBus */ "./resources/frontend/modules/errors/ErrorBus.js");
/* harmony import */ var _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @modules/alerts/Toast */ "./resources/frontend/modules/alerts/Toast.js");
/* harmony import */ var _modules_forms_Form__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @modules/forms/Form */ "./resources/frontend/modules/forms/Form.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    ToggleSwitch: _components_forms_elements_ToggleSwitch__WEBPACK_IMPORTED_MODULE_7__["default"],
    ActionableItem: _components_lists_basic_ActionableItem__WEBPACK_IMPORTED_MODULE_6__["default"],
    ...
    FeatureHeader: _components_layout_header_FeatureHeader__WEBPACK_IMPORTED_MODULE_9__["default"],
    ContextMenuItem: _components_layout_header_ContextMenuItem__WEBPACK_IMPORTED_MODULE_11__["default"],
    ContextMenu: _components_layout_header_ContextMenu__WEBPACK_IMPORTED_MODULE_10__["default"]
  },
  props: {
    id: {
      required: true,
  ...
  data: function data() {
    return {
      usergroups: [],
      user: null,
      form: new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_14__["default"]({
        usergroups: []
      })
    };
  },
  methods: {
    ...
    updateUsergroups: function updateUsergroups() {
      this.form.put('/users/' + this.user.id + '/usergroups').then(function () {
        return new _modules_alerts_Toast__WEBPACK_IMPORTED_MODULE_13__["default"]().success('Usergroups Updated', "This usergroups for this user have been updated.");
      }).catch(function (error) {
        return console.log(error);
      });
    }
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "brand-button",
                            { attrs: { actioning: _vm.isSubmitting } },
