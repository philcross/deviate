...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    form: function form() {
      new _modules_forms_Form__WEBPACK_IMPORTED_MODULE_1__["default"]({
        name: this.collection ? this.collection.name : '',
        description: this.collection ? this.collection.description : '',
        booking_opens_at: this.collection ? this.collection.dates.booking.opens : '',
        booking_closes_at: this.collection ? this.collection.dates.booking.closes : '',
        payment_opens_at: this.collection ? this.collection.dates.payment.opens : '',
        payment_closes_at: this.collection ? this.collection.dates.payment.closes : '',
        activities_start_at: this.collection ? this.collection.dates.activities.start : '',
        activities_end_at: this.collection ? this.collection.dates.activities.end : '',
        is_hidden: this.collection ? this.collection.is_hidden : false
      });
    }
  },
  methods: {
