...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@applications/organisations/components/portlets/standard/DarkPortlet'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'payment-card',
  components: {
    DarkPortlet: !(function webpackMissingModule() { var e = new Error("Cannot find module '@applications/organisations/components/portlets/standard/DarkPortlet'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  props: {
    card: {
      required: true
          ...
          [
            ...
            _c(
              ...
              [
                _vm._v(
                  "\n                XXXX XXXX XXXX " +
                    _vm._s(_vm.card.last_4_digits_) +
                    "\n            "
                )
              ]
            )
      ...
      _c("div", { staticClass: "row" }, [
        _c(
          ...
          [
            _c("payment-card", {
              attrs: {
                card: { id: 1, last_4: 4242, exp_month: "08", exp_year: "2021" }
              }
            })
          ],
          1
        ...
        _c(
          ...
          [
            _c("payment-card", {
              attrs: {
                card: { id: 2, last_4: 5123, exp_month: "09", exp_year: "2020" }
              }
            })
          ],
          1
